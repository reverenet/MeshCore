...
ARGUMENTS
 ...
 build and flash
  ...
  BLE_PIN_FILE  where the pin is read from. Default keys/ble.pin, one line of 6 digits,
...
EXAMPLES
  ...
  echo 456123 > keys/ble.pin        # then every build uses it, and none of them say so
